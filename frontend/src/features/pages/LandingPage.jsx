...
const featureHighlights = [
  {
    title: 'Operacao inteligente',
    description:
      'Automatize confirmacoes, reduza faltas e receba alertas sobre clientes em risco de churn.',
    Icon: Brain,
  },
  {
    title: 'Sua marca em primeiro lugar',
    description:
      'Pagina de agendamento com a sua identidade, dominio personalizado e zero anuncios de terceiros.',
    Icon: ShieldCheck,
  },
  {
    title: 'Agenda sem atritos',
    description:
      'Integracao com WhatsApp, bloqueio de horarios, politicas de antecedencia e fila de espera inteligente.',
    Icon: Clock,
  },
  {
    title: 'Ecossistema conectado',
    description:
      'Pagamentos, contabilidade e marketing plugaveis para voce crescer mantendo o controle dos dados.',
    Icon: Network,
  },
];
...
const testimonials = [
  {
    quote:
      '"Reduzi em 40% os no-shows e dobro a recorrencia com as campanhas automaticas. O painel e um copiloto do meu negocio."',
    name: 'Marina Duarte',
    role: 'Fundadora da GlowUp Studio',
  },
  {
    quote:
      '"A Agenda Facil tirou o caos do meu dia a dia. Meus clientes adoram a praticidade e eu ganhei tempo para focar em estrategia."',
    name: 'Lucas Azevedo',
    role: 'CEO da Barbearia Magnífico',
  },
  {
    quote:
      '"Finalmente tenho visibilidade sobre retencao e faturamento. As metricas em tempo real mudaram minhas decisoes."',
    name: 'Clara Ramos',
...
const pricingTiers = [
  {
    name: 'Gratuito',
    price: 'R$ 0',
    cadence: 'para comecar agora',
    features: [
      'Agenda online com 1 profissional',
      'Painel de confirmacao pelo WhatsApp',
      'Link de agendamento com sua marca',
      'Suporte por e-mail em horario comercial',
    ],
  ...
  },
  {
    ...
    badge: 'Mais popular',
    features: [
      'Ate 5 profissionais e agendas individuais',
      'Sequencias automaticas de reativacao',
      'Integracao com maquininhas e PIX',
      'Relatorios de retencao e ticket medio',
    ],
  ...
  },
  {
    ...
    cadence: 'por mes',
    features: [
      'Equipe ilimitada e gestao de multiplas unidades',
      'Automacao avancada com funis personalizados',
      'API e Webhooks para integracoes externas',
      'Suporte prioritario com account manager',
    ],
...
const faqs = [
  {
    ...
    answer:
      'Nao. A Agenda Facil roda 100% na web, otimizada para desktop e mobile. Voce e seus clientes acessam pelo navegador.',
  },
  {
    question: 'Posso migrar minha base atual?',
    answer:
      'Sim! Importamos clientes, servicos e historico via planilhas ou integracoes. Nossa equipe acompanha todo o processo.',
  },
  {
    question: 'Como funcionam os pagamentos?',
    answer:
      'Voce escolhe: conectar seu gateway favorito ou usar nossa solucao integrada com taxas competitivas e repasse automatico.',
  },
  {
    question: 'E se eu quiser cancelar?',
    answer:
      'Sem fidelidade. Cancele a qualquer momento direto no painel. Seus dados ficam disponiveis para exportacao.',
  },
];

const heroStats = [
  {
    label: 'Media de aumento na retencao',
    value: '+28%',
    Icon: TrendingUp,
  },
  {
  ...
  {
    label: 'Tempo medio para agendar',
    value: '17s',
    Icon: Sparkles,
  },
];
    ...
    <div className="mx-auto max-w-6xl px-6 py-16 lg:py-24 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
      <div className="space-y-5">
        <RevealOnScroll
          as="span"
          delay={80}
          className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.35em] text-indigo-500"
        >
          <Video className="h-4 w-4" />
          Veja na prática
        </RevealOnScroll>
        <RevealOnScroll as="h3" delay={140} className="text-3xl font-bold text-gray-900">
          Seu copiloto para operar com excelência
        </RevealOnScroll>
        <RevealOnScroll as="p" delay={200} className="text-lg text-gray-600 leading-relaxed">
        ...
        <RevealOnScroll delay={260} className="flex flex-col sm:flex-row gap-4">
          {renderLink(
            '/signup',
      ...
      <RevealOnScroll
        delay={200}
        className="relative aspect-video rounded-3xl bg-gradient-to-br from-indigo-500 via-purple-500 to-sky-500 p-[3px] shadow-2xl"
      >
        <div className="h-full w-full rounded-[calc(theme(borderRadius.3xl)-3px)] bg-gray-950/95 p-8 flex flex-col justify-between text-indigo-50">
          <div className="space-y-3">
            <RevealOnScroll
              as="p"
              delay={140}
              className="text-sm uppercase tracking-[0.25em] text-indigo-200"
            >
              Dashboard ao vivo
            </RevealOnScroll>
            <RevealOnScroll as="h4" delay={200} className="text-2xl font-bold text-white">
              Agenda inteligente
            </RevealOnScroll>
            <RevealOnScroll as="p" delay={260} className="text-sm text-indigo-100/80">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        {faqs.map(({ question, answer }) => (
          <RevealOnScroll
            ...
            key={question}
            delay={180}
            className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:shadow-indigo-500/10"
          >
            <div className="absolute inset-x-0 top-0 h-[2px] w-full bg-gradient-to-r from-indigo-500 via-sky-500 to-purple-500 opacity-0 transition group-hover:opacity-100" />
...
const FinalCTASection = ({ renderLink }) => (
  <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-sky-500 py-16 text-white">
    ...
    <div className="relative mx-auto max-w-5xl px-6 text-center">
      <RevealOnScroll as="h3" delay={80} className="text-3xl font-bold">
        Construa experiências memoráveis para seus clientes
      </RevealOnScroll>
      <RevealOnScroll as="p" delay={140} className="mt-4 text-lg text-indigo-100">
        Cadastre-se em minutos, convide sua equipe e descubra como a Agenda Fácil pode se tornar o eixo central do seu
        negócio.
      </RevealOnScroll>
      <RevealOnScroll delay={200} className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
        {renderLink(
          '/signup',
